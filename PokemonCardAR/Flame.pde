class Flame
{
   ...
   public Flame(float x, float y, float z, float xR, float yR, float zR, int nbrParticle, float size, float speed, int lifespamMax)
   {
      ...
      {
         P.add(new Particle(x, y, z, size/2, (int)random(0, lifespamMax)));
